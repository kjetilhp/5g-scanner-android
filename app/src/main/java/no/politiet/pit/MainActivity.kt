...
class MainActivity : Activity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private companion object {
        ...
        val SETTINGS_BACKGROUND: Int = Color.rgb(238, 245, 251)
        val SETTINGS_TEXT: Int = Color.rgb(45, 41, 38)
        val SETTINGS_SUBTLE_TEXT: Int = Color.rgb(95, 93, 92)
        val SETTINGS_ACCENT: Int = Color.rgb(0, 114, 206)
