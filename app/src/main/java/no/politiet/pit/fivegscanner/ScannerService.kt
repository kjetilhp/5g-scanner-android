...
import no.politiet.pit.fivegscanner.domain.CoverageSampleEnhancedPrivacyTransformer
import no.politiet.pit.fivegscanner.domain.GnssMode
import no.politiet.pit.fivegscanner.domain.ReportingMode
import no.politiet.pit.fivegscanner.encoding.CoverageSampleJsonEncoder
...
import no.politiet.pit.fivegscanner.storage.CoverageSampleEntity
import no.politiet.pit.fivegscanner.telemetry.CoverageSampleAssembler
import no.politiet.pit.fivegscanner.telemetry.CoverageSampleAssembler.AssemblyResult
import no.politiet.pit.fivegscanner.telemetry.GnssTelemetrySource
import no.politiet.pit.fivegscanner.telemetry.RadioTelemetrySource
import no.politiet.pit.fivegscanner.telemetry.ScannerTelemetrySnapshot
import no.politiet.pit.fivegscanner.telemetry.TelemetrySourceFactory
...
class ScannerService : Service() {
    ...
    companion object {
        const val ACTION_START = "no.politiet.pit.fivegscanner.ScannerService.START"
        const val ACTION_STOP = "no.politiet.pit.fivegscanner.ScannerService.STOP"
        const val ACTION_STATE_CHANGED = "no.politiet.pit.fivegscanner.ScannerService.STATE_CHANGED"
        const val ACTION_SAMPLE_RECORDED = "no.politiet.pit.fivegscanner.ScannerService.SAMPLE_RECORDED"
