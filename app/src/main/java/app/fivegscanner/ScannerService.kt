...
import app.fivegscanner.encoding.CoverageSampleJsonEncoder
import app.fivegscanner.reporting.ReportingScheduler
import app.fivegscanner.storage.AppSettingsStore
import app.fivegscanner.storage.CoverageDatabaseProvider
import app.fivegscanner.storage.CoverageSampleEntity
import app.fivegscanner.telemetry.CoverageSampleAssembler
import app.fivegscanner.telemetry.CoverageSampleAssembler.AssemblyResult
import app.fivegscanner.telemetry.GnssTelemetrySource
import app.fivegscanner.telemetry.RadioTelemetrySource
import app.fivegscanner.telemetry.ScannerTelemetrySnapshot
import app.fivegscanner.telemetry.TelemetrySourceFactory
...
class ScannerService : Service() {
    ...
    companion object {
        const val ACTION_START = "app.fivegscanner.ScannerService.START"
        const val ACTION_STOP = "app.fivegscanner.ScannerService.STOP"
        const val ACTION_STATE_CHANGED = "app.fivegscanner.ScannerService.STATE_CHANGED"
